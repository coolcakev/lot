...
namespace lotforussr.Migrations
{
    ...
    [Migration("20210714080943_new11")]
    partial class new11
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lotforussr.Models.History", b =>
                {
                    b.HasOne("lotforussr.Models.lot", "Lot")
                        .WithMany("History")
                        .HasForeignKey("LotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lotforussr.Models.User", "Userforbid")
                        .WithMany("Histories")
                        .HasForeignKey("UserforbidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Lot");

                    b.Navigation("Userforbid");
                });
